import Settings from '#src/settings/domains/SettingSchema.js';
import Emails from '#src/settings/domains/EmailSchema.js';
import Preloaders from '#src/settings/domains/PreloaderSchema';
import Profiles from '#src/settings/domains/ProfileSchema';
import Status from '#src/settings/domains/StatusSchema';
import SupportedLanguages from '#src/settings/domains/SupportedLanguagesSchema';
...
export default setSettingsTestData;
